...
function onTouchStart(event) {
  ...
  if (target.closest('button, a, .chatbot-container, #chatbot-details-overlay, #integration-overlay')) {
    return;
  }
...
function onTouchMove(event) {
  ...
  if (target.closest('.chatbot-container, #chatbot-details-overlay, #integration-overlay')) {
    return;
  }
